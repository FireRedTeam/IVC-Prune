...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids=None, unsqueeze_dim=1):
    ...
    """
    print("q shape", q.shape, "k shape", k.shape, "cos shape", cos.shape, "sin shape", sin.shape)
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def fastv_forward(
        ...
        # print("using fastv forward",fastv_config)
            ...
            if use_cache:
                if hidden_states.shape[1] != 1:
                    if layer_idx<FASTV_k:
                        ...
                        # keep index
                        print("FASTV_image_token_start_index", FASTV_image_token_start_index)
                        print("top_attention_rank_index", top_attention_rank_index)
                        print("FASTV_image_token_start_index+FASTV_image_token_length", FASTV_image_token_start_index+FASTV_image_token_length)
                        print("seq_length_with_past", seq_length_with_past)
