...
#     # 1. 处理原图blocks中的bbox tokens
#     # 计算resize后的图片尺寸
#     target_width = image_size * target_aspect_ratio[0]
#     target_height = image_size * target_aspect_ratio[1]
    
#     # 将bbox坐标从原图坐标系转换到resize后的坐标系
...
#     # 确定bbox涉及的block范围
#     block_x1 = int(resized_x1 // image_size)
#     block_y1 = int(resized_y1 // image_size)
#     block_x2 = int(resized_x2 // image_size)
#     block_y2 = int(resized_y2 // image_size)
...
#             # 计算block索引
#             block_idx = block_y * target_aspect_ratio[0] + block_x
            
#             # 计算bbox在当前block内的相对坐标
#             block_left = block_x * image_size
#             block_top = block_y * image_size
            
#             # bbox在当前block内的坐标
#             bbox_in_block_x1 = max(0, resized_x1 - block_left)
#             bbox_in_block_y1 = max(0, resized_y1 - block_top)
#             bbox_in_block_x2 = min(image_size, resized_x2 - block_left)
#             bbox_in_block_y2 = min(image_size, resized_y2 - block_top)
...
#                     token_idx = ty * 15 + tx  # 在当前block内的token索引
#                     token_idx = token_idx + (block_idx+1) * 210 +1 
#                     all_token_positions.append(token_idx)

#             for i in range(14):
#                 token_idx = i * 15 + 14 + (block_idx+1) * 210 +1 
#                 all_token_positions.append(token_idx)

#     # # 2. 如果使用thumbnail，还需要计算bbox在thumbnail中的token位置
#     if use_thumbnail:
#         # thumbnail是整个原图resize到image_size x image_size
#         thumb_scale_x = image_size / orig_width
#         thumb_scale_y = image_size / orig_height
        
#         # bbox在thumbnail中的坐标
#         thumb_x1 = x1 * thumb_scale_x
#         thumb_y1 = y1 * thumb_scale_y
#         thumb_x2 = x2 * thumb_scale_x
#         thumb_y2 = y2 * thumb_scale_y
...
if __name__ == "__main__":
    ...
    conversation = [
        {
            ...
            "images": ["/mnt/public/usr/sunzhichao/benchmark/images/debug/28.jpg"]
    ...
    print("prepare_inputs", prepare_inputs['images'].shape)
    ...
    with torch.no_grad():
        ...
        #     chunk_size=512
        # )
        print("prepare_inputs", prepare_inputs['images_spatial_crop'], prepare_inputs['images_spatial_crop'].shape)
        ...
        outputs = vl_gpt.generate(
            ...
            repetition_penalty=1.1,
            use_cache=True,
            image_pose=all_token_positions
